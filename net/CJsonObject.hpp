...
public:     // method of ordinary json object
    ...
    bool Get(const std::string& strKey, int64_& llValue) const;
    bool Get(const std::string& strKey, uint64_& ullValue) const;
    ...
    bool Add(const std::string& strKey, int64_ llValue);
    bool Add(const std::string& strKey, uint64_ ullValue);
    ...
    bool Replace(const std::string& strKey, int64_ llValue);
    bool Replace(const std::string& strKey, uint64_ ullValue);
...
public:     // method of json array
    ...
    bool Get(int iWhich, int64_& llValue) const;
    bool Get(int iWhich, uint64_& ullValue) const;
    ...
    bool Add(int64_ llValue);
    bool Add(uint64_ ullValue);
    ...
    bool AddAsFirst(int64_ llValue);
    bool AddAsFirst(uint64_ ullValue);
    ...
    bool Replace(int iWhich, int64_ llValue);
    bool Replace(int iWhich, uint64_ ullValue);
