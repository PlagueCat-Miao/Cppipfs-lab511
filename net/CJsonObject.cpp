...
std::string CJsonObject::operator()(const std::string& strKey) const
{
    ...
    else if (pJsonStruct->type == cJSON_Int)
    {
        ...
        {
            if ((int64_)pJsonStruct->valueint <= (int64_)INT_MAX && (int64_)pJsonStruct->valueint >= (int64_)INT_MIN)
            {
                snprintf(szNumber, sizeof(szNumber), "%d", (int32)pJsonStruct->valueint);
            }
            else
            {
                snprintf(szNumber, sizeof(szNumber), "%lld", (int64_)pJsonStruct->valueint);
            }
        }
        else
        {
            if (pJsonStruct->valueint <= (uint64_)UINT_MAX)
            {
...
bool CJsonObject::Get(const std::string& strKey, int64_& llValue) const
{
    cJSON* pJsonStruct = NULL;
    if (m_pJsonData != NULL)
    {
    ...
    if (pJsonStruct->type == cJSON_Int)
    {
        llValue = (int64_)(pJsonStruct->valueint);
        return(true);
    }
    else if (pJsonStruct->type == cJSON_Double)
    {
        llValue = (int64_)(pJsonStruct->valuedouble);
        return(true);
    }
    return(false);
}

bool CJsonObject::Get(const std::string& strKey, uint64_& ullValue) const
{
    cJSON* pJsonStruct = NULL;
    if (m_pJsonData != NULL)
    {
    ...
    if (pJsonStruct->type == cJSON_Int)
    {
        ullValue = (uint64_)(pJsonStruct->valueint);
        return(true);
    }
    else if (pJsonStruct->type == cJSON_Double)
    {
        ullValue = (uint64_)(pJsonStruct->valuedouble);
        return(true);
    }
    return(false);
}
...
bool CJsonObject::Add(const std::string& strKey, int32 iValue)
{
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_)iValue, -1);
    if (pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Add(const std::string& strKey, uint32 uiValue)
{
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_)uiValue, 1);
    if (pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Add(const std::string& strKey, int64_ llValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_)llValue, -1);
    if (pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Add(const std::string& strKey, uint64_ ullValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
...
bool CJsonObject::Replace(const std::string& strKey, int64_ llValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData == NULL)
    {
...
bool CJsonObject::Replace(const std::string& strKey, uint64_ ullValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData == NULL)
    {
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_)ullValue, 1);
    if (pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Get(int iWhich, int64_& llValue) const
{
    cJSON* pJsonStruct = NULL;
    if (m_pJsonData != NULL)
    {
...
bool CJsonObject::Get(int iWhich, uint64_& ullValue) const
{
    cJSON* pJsonStruct = NULL;
    if (m_pJsonData != NULL)
    {
...
bool CJsonObject::Add(int64_ llValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
...
bool CJsonObject::Add(uint64_ ullValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
...
bool CJsonObject::AddAsFirst(int64_ llValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
...
bool CJsonObject::AddAsFirst(uint64_ ullValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
...
bool CJsonObject::Replace(int iWhich, int64_ llValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData == NULL)
    {
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_)((uint64_)llValue), -1);
    if (pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Replace(int iWhich, uint64_ ullValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData == NULL)
    {
